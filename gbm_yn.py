...
if __name__ == "__main__":
    ...
    brats_results = [item for sublist in brats_lists for item in sublist] # Flatten BRATS results list of lists
    all_results = kaggle_results + brats_results # Combine all results
    ...
    joblib.dump(clf, r"D:\GBM_code\rf_brain_tumor_model.joblib")
